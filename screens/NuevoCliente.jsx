...
const NuevoCliente = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchCategorias = async () => {
            try {
                const response = await axios.get('http://192.168.1.76:3000/api/categorias');
    ...
    const fetchProductosPorCategoria = async (categoriaId) => {
        try {
            const response = await axios.get(
                `http://192.168.1.76:3000/api/productos?categoria=${categoriaId}`
            );
    ...
    const handleAddCliente = async () => {
        ...
        try {
            ...
            await axios.post(
                'http://192.168.1.76:3000/api/clientes',
                {
                    nombre,
                    direccion,
                    telefono,
