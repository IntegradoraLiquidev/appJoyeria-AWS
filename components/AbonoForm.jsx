...
const AbonoForm = ({ clienteId, onAddAbono }) => {
    ...
    const handleAddAbono = async () => {
        ...
        try {
            ...
            const response = await axios.post(`https://8oj4qmf2y4.execute-api.us-east-1.amazonaws.com/clientes/agregarabonos?id_cliente=${clienteId}`, { monto: parsedMonto, fecha });
